...
(function(){
  ...
  function ensureCard(){
    ...
    card.addEventListener('change',async event=>{
      ...
      if(error){alert('Support-Status konnte nicht gespeichert werden.');console.warn(error);}else load();
    });
    return card;
  }
